...
SELECT TITLE, AUTHOR, R.BORROWER_NAME, R.RENTAL_DATE
...
SELECT TITLE, AUTHOR
		,(SELECT BORROWER_NAME 
			FROM RENTAL
			WHERE BOOK_ID = TEST_BOOK.BOOK_ID) AS BORROWER_NAME
		,(SELECT RENTAL_DATE 
			FROM RENTAL
			WHERE BOOK_ID = TEST_BOOK.BOOK_ID) AS RENTAL_DATE	
FROM TEST_BOOK;
